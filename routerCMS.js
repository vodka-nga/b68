...
module.exports = function(app, redT) {
    app.post("/apiv1/v1/login", login);
    app.get("/apiv1/v1/getBalance", isAuthenticated, getBalance);
    app.post('/apiv1/v1/changePassword', isAuthenticated, changePassword);
    app.get('/apiv1/v1/admin/getDaily', isAuthenticated, getDaiLy);
    app.get('/apiv1/v1/admin/deleteDaily', isAuthenticated, deleteDaiLy);
    app.post('/apiv1/v1/admin/createDaily', isAuthenticated, addDaiLy);
    app.post('/apiv1/v1/admin/giftcodeDailyAdd', isAuthenticated, addGiftCodeDaiLy);
    app.get('/apiv1/v1/agent/checkNicknameAgent', isAuthenticated, onCheck);
    app.get('/apiv1/v1/agent/checkNicknameAdmin', isAuthenticated, onCheckNicknameAdminTransfer);
    app.post('/apiv1/v1/agent/transferAgent', isAuthenticated, transferAgent);
    app.post('/apiv1/v1/agent/transferAgentOTP', isAuthenticated, transferAgentOTP);
    app.post('/apiv1/v1/admin/transfer', isAuthenticated, isAdmin, transferAdmin);
    app.post('/apiv1/v1/agent/transferHistory', isAuthenticated, agentTransferHistory);
    app.post('/apiv1/v1/agent/reportTransferHistory', isAuthenticated, reportTransferHistory);
    app.get('/apiv1/v1/agent/getDaily2', isAuthenticated, getDaiLy2);
    app.get('/apiv1/v1/agent/deleteDaily2', isAuthenticated, deleteDaiLy2);
    app.post('/apiv1/v1/agent/createDaily2', isAuthenticated, addDaiLy2);
    app.post('/apiv1/v1/agent/profitAgent2', isAuthenticated, profitAgent2);
    app.post('/apiv1/v1/agent/profitAgent', isAuthenticated, profitAgent);
    app.post('/apiv1/v1/agent/giftcodeList', isAuthenticated, giftcodeAgentList);
    app.post('/apiv1/v1/agent/giftcodeStatement', isAuthenticated, giftcodeStatementAgent);
    app.post('/apiv1/v1/agent/freezeTransferHistory', isAuthenticated, freezeTransferHistory);
    app.post('/apiv1/v1/admin/agent/giftcodeList', isAuthenticated, adminGiftcodeListAgent);
    app.get('/apiv1/v1/admin/marketing/giftcodeDelete', isAuthenticated, adminGiftcodeMarketingDelete);
    app.post('/apiv1/v1/admin/marketing/giftcodeList', isAuthenticated, adminGiftcodeMarketingList);
    app.get('/apiv1/v1/admin/marketing/giftcodeExcel', adminGiftcodeMarketingExcel);
    app.post('/apiv1/v1/admin/giftcodeCheck', isAuthenticated, adminGiftcodeCheck);
    app.post('/apiv1/v1/admin/profitAgent', isAuthenticated, adminProfitAgent);
    app.post('/apiv1/v1/admin/agents/transferHistory', isAuthenticated, agentstransferHistory);
    app.post('/apiv1/v1/admin/transferHistory', isAuthenticated, adminTransferHistory);
    app.get('/apiv1/v1/getSummary', isAuthenticated, getSummary);
    app.post('/apiv1/v1/admin/taixiuHistory', isAuthenticated, taixiuHistory);
    app.post('/apiv1/v1/admin/taixiuDeleteTop', isAuthenticated, adminDeleteTopTx);
    app.post('/apiv1/v1/admin/baucuaHistory', isAuthenticated, baucuaHistory);
    app.post('/apiv1/v1/admin/xocdiaHistory', isAuthenticated, xocdiaHistory);
    app.post('/apiv1/v1/admin/minipokerHistory', isAuthenticated, minipokerHistory);
    app.post('/apiv1/v1/admin/mini3cayHistory', isAuthenticated, mini3cayHistory);
    app.post('/apiv1/v1/admin/bigbabolHistory', isAuthenticated, bigbabolHistory);
    app.post('/apiv1/v1/admin/angrybirdsHistory', isAuthenticated, angrybirdsHistory);
    app.post('/apiv1/v1/admin/vuongquocredHistory', isAuthenticated, vuongquocredHistory);
    app.post('/apiv1/v1/admin/candyHistory', isAuthenticated, candyHistory);
    app.post('/apiv1/v1/admin/longlanHistory', isAuthenticated, longlanHistory);
	app.post('/apiv1/v1/admin/zeusHistory', isAuthenticated, zeusHistory);
    app.post('/apiv1/v1/admin/xosoHistory', isAuthenticated, xosoHistory);
    app.post('/apiv1/v1/admin/moneylineHistory', isAuthenticated, moneylineHistory);
    app.post('/apiv1/v1/admin/userlist', isAuthenticated, getUserlist);
    app.get('/apiv1/v1/admin/user/changeStatus', isAuthenticated, isAdmin, changeStatusLogin);
    app.get('/apiv1/v1/admin/user/resetPhone', isAuthenticated, isAdmin, resetPhone);
    app.post('/apiv1/v1/admin/userTransferStatement', isAuthenticated, isAdmin, userTransferStatement);
    app.post('/apiv1/v1/admin/userCardStatement', isAuthenticated, isAdmin, userCardStatement);
    app.post('/apiv1/v1/admin/userDepositCheck', isAuthenticated, isAdmin, userDepositCheck);
    app.get('/apiv1/v1/admin/userHistory', userHistory);
};
